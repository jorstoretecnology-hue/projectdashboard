...
## 3. Middleware vs Proxy
**Regla:** En Next.js 16+, el archivo de control de rutas se llama `src/middleware.ts`, pero internamente nos referimos a la lógica de protección como el **Proxy de Seguridad**.

- No usar `@/middleware` para imports internos si causa conflictos de tipos.
- Toda ruta bajo `/dashboard` o `/api` debe ser verificada por el proxy.
