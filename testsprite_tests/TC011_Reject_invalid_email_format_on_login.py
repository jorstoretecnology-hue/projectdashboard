...
async def run_test():
    ...
    try:
        ...
        # -> Enter an invalid email into the email field (index 7), enter a password (index 8), submit the form (index 10), then wait for the UI to settle so we can verify the inline email validation error and that we remain on the login page.
