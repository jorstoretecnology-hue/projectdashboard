...
## [5.9.9] - 2026-04-04
### ⚡ Performance (Sesión C ✅)
- **perf: cobertura total de índices en Foreign Keys**:
  - Creados 26 índices faltantes en tablas críticas (`automation_logs`, `customers`, `inventory_items`, `sales`, `vehicles`, etc.).
  - Optimización masiva de JOINS y cascadas de integridad referencial.
  - Verificado: 26/26 índices nuevos confirmados en el catálogo de PostgreSQL.
  - Migración: `20260401000006_add_missing_fk_indexes.sql`.
- **Certificación de Estado Estructural**:
  - ✅ 100% de tablas operativas con RLS habilitado y auditado.
  - ✅ 0 Foreign Keys sin índices de cobertura (Sesión C finalizada).
  - ✅ 0 funciones cross-tenant vulnerables conocidas en el core (Sesión A finalizada).
